...
public class ProducerRabbitConfiguration {
    ...
    private String queue; // rk.producer.aula-spring
    ...
    // a direct associa uma exchange a uma queue
    @Bean
    DirectExchange exchange() {
        return new DirectExchange(exchange); // criando uma directExchange
    }
    ...
    @Bean
    Queue parkingLot() { // quando der muito problema voce envia para um fila para analise manual
